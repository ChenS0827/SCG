...
class DeepSeekCoderLoRAInferencer:
    def __init__(self, args):
        ...
        self.results_file = os.path.join(self.results_dir, "deepseek_lora_contract_results.json")
...
def main():
    parser = argparse.ArgumentParser(description="DeepSeekCoder LoRA Inference")
    parser.add_argument("--base_model_path", type=str, default="../deepseek-coder-6.7b-instruct")
    parser.add_argument("--lora_model_path", type=str, default="./deepseekcoder_solidity_lora_8bit/best_model")
    parser.add_argument("--test_data_path", type=str, default="../dataset/test/test.json")
    parser.add_argument("--results_dir", type=str, default="./deepseek_lora_contract_results")
    parser.add_argument("--log_file", type=str, default="deepseek_lora_infer_log.log")
    parser.add_argument("--batch_size", type=int, default=4)
    
    args = parser.parse_args()
    
    inferencer = DeepSeekCoderLoRAInferencer(args)
