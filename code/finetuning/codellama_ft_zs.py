...
class CodeLlamaLoRAInferencer:
    def __init__(self, args):
        ...
        self.results_file = os.path.join(self.results_dir, "codellama_lora_contract_results.json")
        ...
        for batch_idx in tqdm(range(total_batches), desc="Processing Batches"):
            ...
            try:
                ...
                for i in range(len(batch)):
                    ...
                    if generated_code and len(generated_code.strip()) > 20:
...
def main():
    parser = argparse.ArgumentParser(description="CodeLlama LoRA Inference")
    parser.add_argument("--base_model_path", type=str, default="../CodeLlama-7b-Instruct-hf")
    parser.add_argument("--lora_model_path", type=str, default="./codellama_solidity_lora_8bit/best_model")
    parser.add_argument("--test_data_path", type=str, default="../dataset/test/test.json")
    parser.add_argument("--results_dir", type=str, default="./codellama_lora_contract_results")
    parser.add_argument("--log_file", type=str, default="codellama_lora_log.log")
    parser.add_argument("--batch_size", type=int, default=4)
    
    args = parser.parse_args()
    
    inferencer = CodeLlamaLoRAInferencer(args)
